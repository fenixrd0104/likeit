<template>
	<view>
		...
		<view v-show="!showLogin">
			...
			<u-gap height="19" bg-color="#f5f4f4"></u-gap>
			<!-- end -->
			<view class="home-tab flex-box-x flex-y-center">
				<view class="home-tab-list col-xs-x">
					<image class="home-tab-list-img" src="../../static/home/h1.png" @click="clickItemList('setTask')"></image>
					<view class="home-tab-list-txt">
						发布/管理
					</view>
				</view>
				<view class="home-tab-list col-xs-x">
					<image class="home-tab-list-img" src="../../static/home/h6.png" @click="clickItemList('notice')"></image>
					<view class="home-tab-list-txt">
						聊天中心
					</view>
				</view>
				<view class="home-tab-list col-xs-x">
					<image class="home-tab-list-img" src="../../static/home/h2.png"  @click="clickItemList('heiwu')"></image>
					<view class="home-tab-list-txt">
						小黑屋
					</view>
				</view>
				<view class="home-tab-list col-xs-x">
					<image class="home-tab-list-img" src="../../static/home/h7.png" @click="navigateTo({url:'../vip/home?info='+JSON.stringify(userInfo)})"></image>
					<view class="home-tab-list-txt " @click="clickItemList('home')">
						会员中心
					</view>
				</view>
			</view>
			<view class="home-tab flex-box-x flex-y-center">
				<view class="home-tab-list col-xs-x">
					<image class="home-tab-list-img" src="../../static/home/h5.png" @click="clickItemList('inv')"></image>
					<view class="home-tab-list-txt">
						邀请推广
					</view>
				</view>
				<view class="home-tab-list col-xs-x">
					<image class="home-tab-list-img" src="../../static/home/h4.png" @click="clickItemList('rank')"></image>
					<view class="home-tab-list-txt">
						排行榜单
					</view>
				</view>
				<view class="home-tab-list col-xs-x">
					<image class="home-tab-list-img" src="../../static/home/h8.png" @click="clickItemList('help')"></image>
					<view class="home-tab-list-txt">
						帮助中心
					</view>
				</view>
				<view class="home-tab-list col-xs-x">
					<image class="home-tab-list-img" src="../../static/home/h3.png" @click="clickItemList('smrz')"></image>
					<view class="home-tab-list-txt ">
						实名认证
					</view>
				</view>
			...
			<view class="home-tab flex-box-x flex-y-center">
				<view class="home-tab-list col-xs-x">
					<image class="home-tab-list-img" src="../../static/home/H11.png" @click="clickItemList('setting')"></image>
					<view class="home-tab-list-txt">
						设置
					</view>
				</view>
				<view class="home-tab-list col-xs-x">
					<image class="home-tab-list-img" src="../../static/home/H13.png" @click="clickItemList('jifen')"></image>
					<view class="home-tab-list-txt">
						积分
					</view>
				</view>
				<view class="home-tab-list col-xs-x">
					<image class="home-tab-list-img" src="../../static/home/H12.png" @click="clickItemList('tousu')"></image>
					<view class="home-tab-list-txt">
						投诉
					</view>
				</view>
				<view class="home-tab-list col-xs-x">
					<image class="home-tab-list-img" src="../../static/home/H14.png" @click="clickItemList('kefu')"></image>
					<view class="home-tab-list-txt ">
						客服
					</view>
				</view>
